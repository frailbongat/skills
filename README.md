...
I lean on `unslop` for every writing task, but I did not write it. It is part of [Cursor's pstack](https://github.com/cursor/plugins/tree/main/pstack), so it is in the tables below and installed from there.
...
### [cursor/plugins](https://github.com/cursor/plugins), 1 skill
