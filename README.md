...
I lean on `unslop` for every writing task, but I did not write it. It is part of [pstack](https://github.com/backnotprop/pstack), so it is in the tables below and installed from there. Cursor ships a copy of pstack in [cursor/plugins](https://github.com/cursor/plugins/tree/main/pstack), but this repo installs it from the upstream source.
